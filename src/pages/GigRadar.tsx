...
const GigRadar = () => {
  ...
  const { drawRoute } = useOSRMTwoLegRouting();
  ...
  useEffect(() => {
    ...
    drawRoute({
      ...
      onError: (error) => {
        console.warn('[GigRadar] Route error:', error);
      },
    });
  }, [selectedBounty, location, isRider, drawRoute]);
        ...
        <div className="flex-1 flex flex-col relative z-10" style={{ minHeight: 0 }}>
          ...
          >
            ...
            >
                ...
                <Marker longitude={location.lng} latitude={location.lat} anchor="center">
                  <div
                    style={{
                      ...
                      boxShadow: '0 0 20px rgba(179, 124, 28, 0.8)',
                    }}
                  >
                    <div
                      style={{
                        ...
                        background: 'white',
                        borderRadius: '50%',
                        boxShadow: '0 0 12px rgba(179, 124, 28, 0.8)',
              ...
              {/* Bounty markers */}
              {bounties.map((bounty) => (
                <Marker key={bounty.id} longitude={bounty.lng} latitude={bounty.lat} anchor="center">
                  <div
                    onClick={() => {
                    ...
                    style={{
                      ...
                      cursor: 'pointer',
                      fontSize: '20px',
                      boxShadow: '0 0 20px rgba(179, 124, 28, 0.6)',
                    }}
                  >
                    ⚡
                  </div>
                      ...
                      bounties.map((bounty, idx) => (
                        ...
                        >
                          ...
                          {selectedBounty?.id === bounty.id && routeETAMap.has(bounty.id) && (
                            <div
                              className="mb-3 pb-3 border-b p-2 rounded-md text-sm"
                              style={{ backgroundColor: 'rgba(255, 251, 242, 0.1)', borderColor: 'rgba(255, 251, 242, 0.2)' }}
                            >
                          ...
                          <div className="grid grid-cols-2 gap-2 mb-3 pb-3 border-b text-sm" style={{ borderColor: 'rgba(255, 251, 242, 0.2)' }}>
                            <div>
                              <p className="text-xs uppercase tracking-wider" style={{ color: '#FFFBF2/70' }}>
                                Distance
                              </p>
      ...
      <motion.button
        ...
        style={{
          background: isOnline
            ...
            : 'linear-gradient(135deg, #8B6914 0%, #0F1A35 100%)',
          boxShadow: isOnline
