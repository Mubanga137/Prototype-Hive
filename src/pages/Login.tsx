        ...
        <div className="glass-ivory p-8">
          ...
          <div className="grid grid-cols-3 gap-2.5 mb-6">
            <button onClick={() => handleSocialAuth("google")} disabled={loading}
              className="flex items-center justify-center gap-2 py-3 rounded-2xl border-2 border-border bg-secondary/30 hover:border-primary/40 hover:bg-primary/5 transition-all text-sm font-medium text-foreground disabled:opacity-60">
            ...
            <button onClick={() => handleSocialAuth("facebook")} disabled={loading}
              className="flex items-center justify-center gap-2 py-3 rounded-2xl border-2 border-border bg-secondary/30 hover:border-primary/40 hover:bg-primary/5 transition-all text-sm font-medium text-foreground disabled:opacity-60">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPassword ? "text" : "password"} required value={password} onChange={(e) => setPassword(e.target.value)}
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-3 rounded-xl bg-secondary/50 border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 text-sm" />
                <button
                  type="button"
