      ...
      try {
        ...
        try {
          const { data, error: queryError } = await supabase
            .from('orders')
            .select(
              'id, total_price, status, created_at, runner_id, otp_code, hive_catalogue!orders_item_id_fkey(product_name)'
            )
            .eq('buyer_id', user.id)
      ...
      <div className="max-w-5xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          ...
          <p className="text-sm md:text-base mt-2" style={{ color: '#666' }}>
            Real-time tracking for your active orders
          </p>
        </motion.div>
        ...
        {loading ? (
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col items-center justify-center py-24">
            ...
            <p className="text-sm mb-6 max-w-sm text-center" style={{ color: '#666' }}>
              {error}
            </p>
            <button
          ...
          <div className="w-full space-y-6">
            <div className="w-full h-[70vh] rounded-2xl overflow-hidden" style={{ backgroundColor: '#f0f0f0' }}>
              <DestinationMap dropoffLat={customerCoords?.lat} dropoffLng={customerCoords?.lng} />
            </div>
            ...
            {orders.map((order, i) => {
              ...
              return (
                ...
                >
                  {isInTransit && (
                    <>
                      <div className="w-full h-[70vh] rounded-2xl overflow-hidden shadow-lg" style={{ backgroundColor: '#f0f0f0' }}>
                        <DestinationMap orderId={order.id} />
                      </div>
                      ...
                      <motion.div
                        ...
                        className="p-5 rounded-xl shadow-sm backdrop-blur-md"
                        style={{
                          backgroundColor: 'rgba(255, 251, 242, 0.8)',
                      ...
                      >
                        ...
                        <div className="space-y-2.5">
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-sm font-semibold" style={{ color: '#0F1A35' }}>
                        ...
                        <div key={si} className="flex-1 flex flex-col items-center relative">
                          ...
                          {si < stepLabels.length - 1 && (
                            <div
                              ...
                              style={{
                                backgroundColor:
                                  si < currentStep ? '#D4A574' : si === currentStep ? '#D4A57466' : '#e0e0e0',
                              }}
                            />
                          )}
                        </div>
