...
-- Issue: PostgreSQL cannot choose between conflicting signatures
-- Solution: Drop all versions and recreate ONLY the correct one
-- =====================================================================

-- STEP 1: Drop all versions of secure_place_order (all possible signatures)
-- This handles incorrect UUID variants, old TEXT date types, and other misfires
...
-- STEP 2: Recreate ONLY the correct function with proper types
...
-- STEP 3: Grant execution rights to all users (anon + authenticated)
...
-- =====================================================================
-- VERIFICATION: Confirm only ONE function exists
-- =====================================================================
/*
SELECT 
  routine_name,
  string_agg(data_type, ', ')::text as parameter_types
...
-- secure_place_order      | uuid, bigint, bigint, bigint, integer, ...
*/
